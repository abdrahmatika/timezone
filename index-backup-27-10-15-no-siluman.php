			...
			<table class="table table-hover table-bordered">
				...
				<?php if ( $sql->num_rows > 0 ) {
					...
					while ( $r = $sql->fetch_assoc() ) { 
						...
						// TOTAL
							$tot_bobot_all 	= $tot_bobot_pdb + $tot_bobot_t + $tot_bobot_siakad_lama - $kurangi_bobot;
							$tot_sks_all  	= $tot_sks_pdb + $tot_sks_t + $tot_sks_siakad_lama - $kurangi_sks;
